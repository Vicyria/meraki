...
export default function Introduction() {
    return(
        <>
        <div className="mt-4 p-4 max-w-4xl flex flex-col flex-auto border bg-white/30 border-white/50 rounded-xl shadow-[4px_4px_rgba(255,255,255,0.5)] backdrop-blur-sm mx-auto mb-12">
            <div className="flex flex-col justify-center align-center mb-1">
                <h3 className="intro-heading">Meet yer Cap'n!</h3>
            </div>
            <div className="flex flex-row">
                <div className="mt-3 w-3/4  height-xl radius-l">
                ...
                <div className="w-1/4 height-xl border-4 border-black/20 rounded-[50%]">
                <img className = "rounded-[50%] " src = "/photo.jpg"></img> 
                </div>
            </div>
        </div>
        </>
